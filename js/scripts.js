...
/*attempting to create a list of pokemon here on the DOM, but I am not fully sure these can be considered a loops*/
for (let i=0 ; i < pokemonList.length; i++);
    if (pokemonList[0].type = 'electric' && pokemonList[0].height === 1.2) {
    document.write('<p>Pikachu (height:1.2)');
    } else {
...
for (let i=0; i < pokemonList.length; i++);
    ...
    document.write('<p>Blastois (height:2.0)');
    } else {
...
for (let i=0; i < pokemonList.length; i++);
    ...
    document.write('<p class="special_pokemon">Charizard (height:6.1)');
    } else {
